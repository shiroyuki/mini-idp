...
class PredefinedScope(Enum):
    ...
    IAM_CLIENT_WRITE = IAMScope.predefined('idp.client.write', 'Write OAuth clients', sensitive=True)
    ...
    IAM_POLICY_WRITE = IAMScope.predefined('idp.policy.write', 'Write IAM policies', sensitive=True)
    ...
    IAM_ROLE_WRITE = IAMScope.predefined('idp.role.write', 'Write IAM roles', sensitive=True)
    ...
    IAM_SCOPE_WRITE = IAMScope.predefined('idp.scope.write', 'Write IAM scopes', sensitive=True)
